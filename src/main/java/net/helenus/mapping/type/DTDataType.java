...
public final class DTDataType extends AbstractDataType {
  ...
  public DTDataType(ColumnType columnType, DataType dataType) {
    this(
        columnType,
        dataType,
        CodecRegistry.DEFAULT_INSTANCE.codecFor(dataType).getJavaType().getClass(),
        EMPTY_CLASSES);
  }
  ...
  public DTDataType(
      ColumnType columnType, DataType dataType, Class<?> javaClass, Class<?>[] typeArguments) {
    super(columnType);
  ...
  public static DTDataType list(
      ColumnType columnType, DataType argumentDataType, Type argumentType) {
  ...
  public static DTDataType map(
    ...
    return new DTDataType(
        columnType,
        mapDataType,
        CodecRegistry.DEFAULT_INSTANCE.codecFor(mapDataType).getClass(),
        typeArguments);
  }
      ...
      switch (columnType) {
        ...
        default:
          throw new HelenusMappingException(
              "unable to alter " + columnType + " column " + columnName);
      }
    }
