...
public final class UDTSetDataType extends AbstractDataType {
  ...
  public UDTSetDataType(ColumnType columnType, IdentityName udtName, Class<?> udtClass) {
    super(columnType);
  ...
  private SchemaStatement notSupportedOperation(String op, IdentityName columnName) {
    throw new HelenusMappingException(
        op + " UDTSet column is not supported by Cassandra Driver for column '" + columnName + "'");
  }
