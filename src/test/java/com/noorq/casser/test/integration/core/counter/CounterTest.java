 ...
 */
package com.noorq.casser.test.integration.core.counter;
...
public class CounterTest extends AbstractEmbeddedCassandraTest {
	...
	static Page page = Casser.dsl(Page.class);
	
	static CasserSession session;

	@BeforeClass
	public static void beforeTest() {
		session = Casser.init(getSession()).showCql().add(page).autoCreateDrop().get();
	}
